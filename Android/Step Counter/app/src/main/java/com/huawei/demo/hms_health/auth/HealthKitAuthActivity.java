...
package com.huawei.demo.hms_health.auth;
...
public class HealthKitAuthActivity extends Activity {
    ...
    private HealthKitAuthResult result;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_AUTH) {
            ...
            result = mSettingController.parseHealthKitAuthResultFromIntent(data);
            if (result == null) {
    ...
    public boolean getAuthResult(){
        //TODO: CHANGE LATER SO THE BUTTON LOGIN WILL GONE ON SUCCESS AUTH
        if(result == null){
            return false;
        }else{
            if(result.isSuccess()){
